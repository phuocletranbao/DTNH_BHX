...
# ===== 4. Ước tính doanh thu & số lượng tháng này dựa trên số ngày hiện tại - 1 =====
today = datetime.now().day - 1  # ví dụ hôm nay là 7/10 -> lấy 6
if today <= 0:
...
# ===== 7. Hiển thị chỉ số tổng quan =====
st.title("📊 Báo cáo Doanh thu & Số lượng Dự kiến Tháng 10")
